...
ON YEAR(o1.odate) = 2014
INNER JOIN orders o2
ON YEAR(o2.odate) = 2013
AND o1.pid = o2.pid
...
SELECT DISTINCT c.cid, c.cname, c.residence
FROM customers c
INNER JOIN orders o
ON o.cid = c.cid
INNER JOIN products p
